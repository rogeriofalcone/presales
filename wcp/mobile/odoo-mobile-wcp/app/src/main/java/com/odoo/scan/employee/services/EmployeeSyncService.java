package com.odoo.scan.employee.services;
 ...
 */
public class EmployeeSyncService extends Service {
    ...
    public void performSync(Context context, Account account, Bundle extras,
        ...
        EmployeeModel db = new EmployeeModel(context);
    ...
    public class SyncAdapterImpl extends AbstractThreadedSyncAdapter {
        ...
        public void onPerformSync(Account account, Bundle bundle, String str,
            ...
            if (account != null) {
                new EmployeeSyncService().performSync(mContext, account,
